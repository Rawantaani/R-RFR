...
const Details = () => {
 ...
 const removeItem=async()=>{
  try{
    const res=await ax.delete("https://rawan-zbw7.onrender.com/api/items/"+id)
    console.log(res)
  }catch(error){
console.log(error)
  }
    ...
    <div className="container mt-5">
      ...
      <form className="productDetails row">
        <div className="col-md-6">
          <br />
          <img src={`https://rawan-zbw7.onrender.com/uploads/${thumbnail}`} style={{ height: 300, width: '300px' }} className="card-img-top" alt="Product Image" />
          <br /><br />
