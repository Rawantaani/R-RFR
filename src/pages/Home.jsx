...
const Home = () => {
  ...
  const bulr="https://rawan-zbw7.onrender.com/api/items/"
        ...
        itemsData.map((item, index) => (
          <div key={index} className="col mb-4">
            <div className="card h-100">
              <img src={`https://rawan-zbw7.onrender.com/uploads/${item.thumbnail}`}style={{ height:'100%', width: '100%' }} className="card-img-top" alt="Product Image" />
