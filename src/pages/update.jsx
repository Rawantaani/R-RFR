...
const updateProduct = () => {
  ...
  const updateItem = async (e) => {
    ...
    try {
      const response = await fetch(`https://rawan-zbw7.onrender.com/api/items/${id}`, {
        method: "PATCH",
        body: formData,
      })
      if (response.ok) {
  ...
  return (
    <div className="container mt-5">
      ...
      {
        submitted ? (<p>Data submitted successfully!</p>) :( <form className="productDetails row" onSubmit={updateItem}>
          <div className="col-md-6">
            <label>Upload Photo</label>
            <br />
            <img src={`https://rawan-zbw7.onrender.com/uploads/${thumbnail}`}style={{ height: 300, width: '300px' }} alt="Product Image" />
            <br /><br />
            <input
              type="file"
